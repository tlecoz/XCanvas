class BitmapPath extends Path {
  ...
  public convertLinesToCurves(smoothLevel:number=1):void{
    ...
    var j:number,nb:number,k:number=0;
    var bezier;
    var points = [];
    for(i=0;i<len;i++){
  ...
  */
  ...
  public get outsideBitmap():BorderPt[]{return this._outsideBitmap}
  public get holeBitmap():BorderPt[][]{return this._holeBitmap}

  public get outsideVector():BorderPt[]{return this._outsideVector}
  public get holeVector():BorderPt[][]{return this._holeVector}

  public get outsideCurves():number[][][]{return this._outsideCurves}
  public get holeCurves():number[][][][]{return this._holeCurves}
