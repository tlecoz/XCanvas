...
export class SolidColor extends EventDispatcher {
  ...
  constructor(r: number | string, g: number = -1, b: number = 0, a: number = 1) {
    ...
    var red: number | undefined = undefined;
    if (g == -1) {
      if (typeof (r) == "string") {
    ...
    if (red == undefined) red = r as number;
  ...
  public get style(): string | undefined { return this._style; }
