export class EarCutting {
    ...
    private vertexCount: any;
    private vertexTypes: any;
    ...
    private nextIndex(index: number): number { return (index + 1) % this.vertexCount; }
    ...
    private _computeTriangles(arrayXY: number[], offset: number, count: number) {
